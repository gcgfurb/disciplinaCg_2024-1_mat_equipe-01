...
namespace gcgcg
{
    public class Mundo : GameWindow
    {
        ...
        private List<PrimitiveType> primitivas = new List<PrimitiveType>();
        ...
        protected override void OnLoad()
        {
            ...
            primitivas.Add(PrimitiveType.Points);
            primitivas.Add(PrimitiveType.Lines);
            primitivas.Add(PrimitiveType.LineLoop);
            primitivas.Add(PrimitiveType.LineStrip);
            primitivas.Add(PrimitiveType.Triangles);
            primitivas.Add(PrimitiveType.TriangleStrip);
            primitivas.Add(PrimitiveType.TriangleFan);

            #region Objeto: retângulo  
            objetoSelecionado = new Retangulo(mundo, ref rotuloAtual, new Ponto4D(-0.5, 0.5), new Ponto4D(0.5, -0.5));
            objetoSelecionado.PrimitivaTipo = primitivas[primitiveIndex];
            #endregion
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {   
                            if(primitiveIndex == primitivas.Count) {
                                primitiveIndex = 0;
                            }
