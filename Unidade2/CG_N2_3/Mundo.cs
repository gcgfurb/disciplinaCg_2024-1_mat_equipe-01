...
namespace gcgcg
{
    public class Mundo : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            raio = Matematica.distancia(objetoSelecionado.PontosId(0), objetoSelecionado.PontosId(1));
            pos = 0;
            angulo = 45;
        }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    pos -= 0.5;
                                    objetoSelecionado.PontosAlterar(new Ponto4D(pos, origem.Y, 0), 0);
                                    objetoSelecionado.PontosAlterar(new Ponto4D(fim.X - 0.5, fim.Y, 0), 1);
                                }
                                else
                                {
                                    ...
                                    else
                                    {
                                        if (input.IsKeyPressed(Keys.A))
                                        {
                                            ...
                                            objetoSelecionado.PontosAlterar(ponto, 1);
                                        }
                                        else
                                        {
